...
def positive_assert(first_name):
    ...
    user_response = sender_stand_request1.post_new_user(user_body)

    assert user_response.status_code == 201
    assert user_response.json()["authToken"] != ""

    users_table_response = sender_stand_request1.get_users_table()
...
def negative_assert_symbol(first_name):
    ...
    response = sender_stand_request1.post_new_user(user_body)
